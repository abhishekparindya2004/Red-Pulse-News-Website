...
<div class="topbar">
  <div class="wrap">
    <div class="left">
      ...
      <span>Sports Desk • Verified Updates</span>
    </div>
    <div class="right">
  ...
  <div class="wrap">
    ...
    <div class="header-actions">
      <div class="search" title="Search within this section page">
        ...
        <input id="siteSearch" type="search" placeholder="Search Sports stories..."/>
      </div>
...
<div class="ticker">
  <div class="wrap">
    ...
    <div class="scroll">
      <span>Sports desk: highlights + tactics • Fast headlines with simple tactical explanations • Use search to filter stories •</span>
    </div>
  </div>
</div>
...
<div class="container">
  <div class="grid">
    ...
    <main class="card pad">
      <div class="h">
        <h2>Sports desk: highlights + tactics</h2>
        <div class="small">Fast headlines with simple tactical explanations</div>
      </div>

      <div class="news-grid">
        <article class="news-card" data-search="football championship finals draw global attention what made the match tactical and why the press mattered">
          <img src="images/s1.png" alt="">
          <div class="body">
            <span class="tag">Football</span>
            <h3>Championship finals draw global attention</h3>
            <p>What made the match tactical — and why the press mattered.</p>
            <div class="meta-row"><span>5 min</span><a class="readmore" href="index.php#latest">More →</a></div>
          </div>
        </article>

        <article class="news-card" data-search="basketball playoffs heat up with unexpected upsets momentum swings rotations and clutch defense breakdown">
          <img src="images/s2.png" alt="">
          <div class="body">
            <span class="tag">Basketball</span>
            <h3>Playoffs heat up with unexpected upsets</h3>
            <p>Momentum swings, rotations, and clutch defense breakdown.</p>
            <div class="meta-row"><span>4 min</span><a class="readmore" href="index.php#latest">More →</a></div>
          </div>
        </article>

        <article class="news-card" data-search="tennis grand slam highlights a new champion emerges the key improvements that changed everything serve mental game">
          <img src="images/s3.png" alt="">
          <div class="body">
            <span class="tag">Tennis</span>
            <h3>Grand Slam highlights: a new champion emerges</h3>
            <p>The key improvements that changed everything: serve + mental game.</p>
            <div class="meta-row"><span>5 min</span><a class="readmore" href="index.php#latest">More →</a></div>
          </div>
        </article>
     ...
     <aside class="card">
      <div class="widget">
        ...
        <div class="list">
          <div>
            <a href="index.php#latest">Finals night hits record viewership across multiple regions</a>
            <div class="li">What went viral + tactical breakdown.</div>
          </div>
          <div>
            <a href="sports.php">Powerplay strategies: why early wickets change games</a>
            <div class="li">Field settings + run-rate pressure, simplified.</div>
          </div>
          <div>
            <a href="sports.php">Playoffs heat up with unexpected upsets</a>
            <div class="li">Rotations, momentum swings, clutch defense.</div>
          </div>
        </div>
      </div>
    </aside>
